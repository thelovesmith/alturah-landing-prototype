...
//           Welcome to Gatsby with Tailwind CSS
//         </h1>
//         <p className="mb-4">
//           This is a simple example of how to use Tailwind CSS in a Gatsby.js
//           project.
//         </p>
//         <Link to="/page-2/" className="text-indigo-600 hover:text-indigo-900">
//           Go to Page 2
//         </Link>
//       </div>
//     </div>
...
//           Welcome to Gatsby with Tailwind CSS
//         </h1>
//         <UsersIcon className="w-6 h-6 text-indigo-500 mb-4" />
//         <p className="mb-4">
//           This is a simple example of how to use Tailwind CSS and Heroicons in a
//           Gatsby.js project.
//         </p>
//         <Link to="/page-2/" className="text-indigo-600 hover:text-indigo-900">
//           Go to Page 2
